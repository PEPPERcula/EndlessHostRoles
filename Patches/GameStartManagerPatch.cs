        ...
        public static void Postfix(GameStartManager __instance)
        {
            try
            {
                ...
                int estimatedGameLength = Options.CurrentGameMode switch
                {
                    ...
                    CustomGameMode.FreeForAll => Math.Clamp((FreeForAll.FFAKcd.GetInt() * (PlayerControl.AllPlayerControls.Count / 2)) + FreeForAll.FFAKcd.GetInt(), FreeForAll.FFAKcd.GetInt(), FreeForAll.FFAGameTime.GetInt()),
