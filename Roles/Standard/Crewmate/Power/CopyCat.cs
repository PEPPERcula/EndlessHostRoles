    ...
    public override bool OnCheckMurder(PlayerControl pc, PlayerControl tpc)
    {
        ...
        if (CopyCrewVar.GetBool())
        {
            var newRole = role switch
            {
                ...
                CustomRoles.Pawn or CustomRoles.Workaholic => CustomRoles.Snitch,
                CustomRoles.Fabricator or CustomRoles.Sunnyboy => new[] {CustomRoles.Doctor, CustomRoles.ScientistEHR}.RandomElement(),
                ...
                CustomRoles.Occultist or CustomRoles.Summoner => CustomRoles.Altruist,
                CustomRoles.Catalyst or CustomRoles.Dealer or CustomRoles.MoonDancer => CustomRoles.Merchant,
                ...
                CustomRoles.Wildling or CustomRoles.BloodKnight => CustomRoles.Safeguard,
                CustomRoles.PlagueBearer => CustomRoles.Socialite,
                CustomRoles.Demon => CustomRoles.Spy,
                CustomRoles.RiftMaker => CustomRoles.PortalMaker,
                ...
                CustomRoles.Saboteur or CustomRoles.Technician => CustomRoles.Mechanic,
                ...
                CustomRoles.Ninja or CustomRoles.Hookshot => new[] {CustomRoles.Tether, CustomRoles.Transmitter}.RandomElement(),
